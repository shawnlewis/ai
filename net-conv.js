...
var x = patchesAhead + patchesBehind
var y = lanesSide * 2 + 1
...
var depth = temporal_window + 1

var deepqlearn2 = deepqlearn2 || { REVISION: 'ALPHA' };

// Hacked to allow convolutional layers.
// Input is just most temporal_window+1 states, no longer includes actions
(function(global) {
  "use strict";
  ...
  Brain.prototype = {
    ...
    policy: function(s) {
      ...
      var svol = new convnetjs.Vol(x, y, depth);
      svol.w = s;
    ...
    getNetInput: function(xt) {
			// Shawn: modified to not put actions in state vector
...
(function(lib) {
  ...
  if (typeof module === "undefined" || typeof module.exports === "undefined") {
    window.deepqlearn2 = lib; // in ordinary browser attach library to window
  } else {
...
brain = new deepqlearn2.Brain(num_inputs, num_actions, opt);
