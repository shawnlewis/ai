...
import dataset_sealions
dataset_factory.datasets_map['sealions'] = dataset_sealions
...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        'Accuracy': accuracy,
        'Precision': slim.metrics.streaming_recall(predictions, labels),
        'Recall': slim.metrics.streaming_precision(predictions, labels)
